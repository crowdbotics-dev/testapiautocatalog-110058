...
## Project Structure
    ...
    ├── testapiautocatalog_110058  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_110058`
...
2. Clone this repo and `cd testapiautocatalog_110058`
